...
export default function Home() {
  ...
  return (
    <Layout title={`Homepage`} description="Scottie Enriquez">
      <main>
        <div className={'home-container'}>
          <div className="container">
            ...
            <div className={'text--center'}>
              ...
              <Link to={'/discussing-fantasy-football'}>
                <FontAwesomeIcon icon={faFootball} size={'2x'} />
              </Link>{' '}
              <Link to={'https://github.com/scottenriquez'}>
                <FontAwesomeIcon icon={faGithub} size={'2x'} />
              </Link>{' '}
              <Link to={'https://www.linkedin.com/in/scottenriquez/'}>
