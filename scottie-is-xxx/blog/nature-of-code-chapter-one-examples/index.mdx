...
Leveraging the [clock's time delta](https://threejs.org/docs/#api/en/core/Clock) (i.e., the time elapsed since the last frame) for scalar multiplication and normalizing the sphere velocity vector are the first steps for simulating motion.
